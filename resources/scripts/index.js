...
function clearAndDrawGrid(e) {
    ...
    while (true) {
        let newGridSize = parseInt(prompt("Enter column and row size. Please choose less than 100"));
...
rainbowButton.forEach(button => button.addEventListener('click', handleColor));
